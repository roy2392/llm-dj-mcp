        ...
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <Input
                    ...
                    className="bg-gray-900 border-gray-600 text-white placeholder-gray-400 focus:border-green-500 focus:ring-green-500"
                  />
                  <Button
          ...
          <div className="space-y-6">
            {playlist && (
              <>
                {/* DJ Comment */}
                <Card className="bg-gradient-to-r from-green-900/50 to-gray-800 border-green-700">
                  <CardContent className="p-6">
            ...
            {!playlist && !isGenerating && (
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 border-dashed">
